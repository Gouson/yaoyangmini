...
export default {
	...
	methods: {
		...
		goToCreateOrderPage() { uni.navigateTo({ url: '/pages/cs/createOrder' }); },
...
<style scoped>
.cs-dashboard-container { padding: 20rpx; background-color: #f4f4f4; min-height: 100vh; box-sizing: border-box; }
...
.create-order-btn { background-color: #007aff; color: white; }
...
.loading-text, .empty-text { text-align: center; color: #999; padding: 50rpx 0; font-size: 28rpx; }
.unauthorized-container { display: flex; flex-direction: column; align-items: center; justify-content: center; height: 70vh; text-align: center; color: #666; font-size: 28rpx; }
